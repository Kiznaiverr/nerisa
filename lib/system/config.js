...
global.creator = '@kiznavierr - nerisa.bot'
global.Api = AlyaApi(process.env.API_ENDPOINT, process.env.API_KEY)
global.header = `nerisa-bot v${require('package.json').version}`
global.footer = Func.Styles('simple whatsapp bot made by nerisa')
